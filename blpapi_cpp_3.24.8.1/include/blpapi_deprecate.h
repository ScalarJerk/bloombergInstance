...
#define BLPAPI_DEPRECATE_IMP(SEVERITY, URL, MESSAGE) [[ deprecated("severity=\"" SEVERITY "\", url=\"" URL "\", message=\"" MESSAGE "\"")]]
...
#define BLPAPI_DEPRECATE_STAGE_THRESHOLD BLPAPI_DEPRECATE_STAGE_LEVEL_DEFAULT_WARNING
#endif
...
#if defined(BLPAPI_DEPRECATE_ENABLE_MESSAGE_TOPIC_NAME) && defined(BLPAPI_DEPRECATE_DISABLE_MESSAGE_TOPIC_NAME)
...
#define BLPAPI_DEPRECATE_MESSAGE_TOPIC_NAME__ENABLED 1
#elif (BLPAPI_DEPRECATE_STAGE_THRESHOLD    <= BLPAPI_DEPRECATE_STAGE_LEVEL_DEFAULT_WARNING) &&       \
      (BLPAPI_DEPRECATE_SEVERITY_THRESHOLD <= BLPAPI_DEPRECATE_SEVERITY_LEVEL_STANDARD) && \
...
#define BLPAPI_DEPRECATE_MESSAGE_TOPIC_NAME_JSON R"text({"feature": "message_topic_name", "description": "Deprecating blpapi::Message::topicName() method", "severity": "standard", "stage": "default_warning", "url": "https://bloomberg.github.io/blpapi-docs/cpp/3.24.4/classBloombergLP_1_1blpapi_1_1Message.html#a4ecdba068f788562c4cc919a735d253b", "message": "This method always returns an empty string", "library": "blpapi", "group": "blpapi"})text"

#if defined(BLPAPI_DEPRECATE_MESSAGE_TOPIC_NAME__ENABLED)
#if defined(BB_DEPRECATE_ENABLE_JSON_MESSAGE)
#define BLPAPI_DEPRECATE_MESSAGE_TOPIC_NAME          BLPAPI_DEPRECATE_IMP_CONFIG(BLPAPI_DEPRECATE_MESSAGE_TOPIC_NAME_JSON)
#define BLPAPI_DEPRECATE_MESSAGE_TOPIC_NAME_MSG(MSG) BLPAPI_DEPRECATE_MESSAGE_TOPIC_NAME
#else
#define BLPAPI_DEPRECATE_MESSAGE_TOPIC_NAME \
           BLPAPI_DEPRECATE_IMP("standard", \
                         "https://bloomberg.github.io/blpapi-docs/cpp/3.24.4/classBloombergLP_1_1blpapi_1_1Message.html#a4ecdba068f788562c4cc919a735d253b", \
...
#if defined(BLPAPI_DEPRECATE_ENABLE_ABSTRACT_SESSION_CREATE_USER_HANDLE) && defined(BLPAPI_DEPRECATE_DISABLE_ABSTRACT_SESSION_CREATE_USER_HANDLE)
...
#elif (BLPAPI_DEPRECATE_STAGE_THRESHOLD    <= BLPAPI_DEPRECATE_STAGE_LEVEL_DEFAULT_WARNING) &&       \
      (BLPAPI_DEPRECATE_SEVERITY_THRESHOLD <= BLPAPI_DEPRECATE_SEVERITY_LEVEL_STANDARD) && \
      (!defined(BLPAPI_DEPRECATE_DISABLE_ABSTRACT_SESSION_CREATE_USER_HANDLE)) &&                                      \
      (!defined(BLPAPI_DEPRECATE_DISABLE_ALL))
#define  BLPAPI_DEPRECATE_ABSTRACT_SESSION_CREATE_USER_HANDLE__ENABLED 1
#endif  // defined(BB_DEPRECATE_ENABLE_ALL_DEPRECATIONS_FOR_TESTING)
...
#if defined(BLPAPI_DEPRECATE_ABSTRACT_SESSION_CREATE_USER_HANDLE__ENABLED)
#if defined(BB_DEPRECATE_ENABLE_JSON_MESSAGE)
#define BLPAPI_DEPRECATE_ABSTRACT_SESSION_CREATE_USER_HANDLE          BLPAPI_DEPRECATE_IMP_CONFIG(BLPAPI_DEPRECATE_ABSTRACT_SESSION_CREATE_USER_HANDLE_JSON)
#define BLPAPI_DEPRECATE_ABSTRACT_SESSION_CREATE_USER_HANDLE_MSG(MSG) BLPAPI_DEPRECATE_ABSTRACT_SESSION_CREATE_USER_HANDLE
#else
#define BLPAPI_DEPRECATE_ABSTRACT_SESSION_CREATE_USER_HANDLE \
           BLPAPI_DEPRECATE_IMP("standard", \
                         "https://bloomberg.github.io/blpapi-docs/cpp/3.24.4/classBloombergLP_1_1blpapi_1_1AbstractSession.html#a5e2f9d667e3f1d0bf4891268919d3e83", \
...
#if defined(BLPAPI_DEPRECATE_ENABLE_STRING_NAME) && defined(BLPAPI_DEPRECATE_DISABLE_STRING_NAME)
...
#define BLPAPI_DEPRECATE_STRING_NAME_JSON R"text({"feature": "string_name", "description": "Deprecating methods taking the 'name' argument by string", "severity": "standard", "stage": "default_warning", "url": "", "message": "Use the form that takes blpapi::Name instead of const char*", "library": "blpapi", "group": "blpapi"})text"

#if defined(BLPAPI_DEPRECATE_STRING_NAME__ENABLED)
#if defined(BB_DEPRECATE_ENABLE_JSON_MESSAGE)
#define BLPAPI_DEPRECATE_STRING_NAME          BLPAPI_DEPRECATE_IMP_CONFIG(BLPAPI_DEPRECATE_STRING_NAME_JSON)
...
#define BLPAPI_DEPRECATE_STRING_NAME_MSG(MSG) \
           BLPAPI_DEPRECATE_IMP("standard", \
                         "",  \
                         "Use the form that takes blpapi::Name instead of const char*: " MSG)
#endif  // defined(BB_DEPRECATE_ENABLE_JSON_MESSAGE)
